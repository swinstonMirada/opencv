 ...
 * @param borderType pixel extrapolation method (see <code>borderInterpolate</code>
 * for details).
 *
 ...
 * <p>return -1;</p>
 *
 * <p>cvtColor(img, gray, COLOR_BGR2GRAY);</p>
 *
 ...
 *
 * <p>HoughCircles(gray, circles, HOUGH_GRADIENT,</p>
 *
 ...
 * @param min_theta For standard and multi-scale Hough transform, minimum angle
 * to check for lines. Must fall between 0 and max_theta.
 * @param max_theta For standard and multi-scale Hough transform, maximum angle
 * to check for lines. Must fall between min_theta and CV_PI.
 *
 ...
 *
 * <p>cvtColor(dst, color_dst, COLOR_GRAY2BGR);</p>
 *
 * <p>#if 0</p>
 *
 ...
 * @see org.opencv.imgproc.LineSegmentDetector : public Algorithm
 */
 ...
 * below.
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/colormaps.html#applycolormap">org.opencv.imgproc.Imgproc.applyColorMap</a>
 */
 ...
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/drawing_functions.html#arrowedline">org.opencv.imgproc.Imgproc.arrowedLine</a>
 */
...
/**
 * <p>Finds the four vertices of a rotated rect. Useful to draw the rotated
 * rectangle.</p>
 *
 * <p>The function finds the four vertices of a rotated rectangle. This function is
 ...
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/structural_analysis_and_shape_descriptors.html#boxpoints">org.opencv.imgproc.Imgproc.boxPoints</a>
 */
 ...
 * <p>return -1;</p>
 *
 * <p>cvtColor(src, hsv, COLOR_BGR2HSV);</p>
 *
 ...
 * in the radius value.
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/drawing_functions.html#circle">org.opencv.imgproc.Imgproc.circle</a>
 */
 ...
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/drawing_functions.html#clipline">org.opencv.imgproc.Imgproc.clipLine</a>
 */
 ...
 *
 * <ul>
 *   <li> Alternative Chi-Square (<code>method=CV_COMP_CHISQR_ALT</code>)
 * </ul>
 *
 * <p><em>d(H_1,H_2) = 2 * sum _I((H_1(I)-H_2(I))^2)/(H_1(I)+H_2(I))</em></p>
 *
 * <p>This alternative formula is regularly used for texture comparison. See e.g.
 * [Puzicha1997].</p>
 * <ul>
 ...
 *
 * <ul>
 *   <li> Kullback-Leibler divergence (<code>method=CV_COMP_KL_DIV</code>).
 * </ul>
 *
 * <p><em>d(H_1,H_2) = sum _I H_1(I) log((H_1(I))/(H_2(I)))</em></p>
 *
 ...
 *   <li> CV_COMP_CHISQR_ALT Alternative Chi-Square
 ...
 *   <li> CV_COMP_KL_DIV Kullback-Leibler divergence
 * </ul>
 *
...
/**
 * <p>computes the connected components labeled image of boolean image
 * <code>image</code> with 4 or 8 way connectivity - returns N, the total number
 * of labels [0, N-1] where 0 represents the background label. ltype specifies
 * the output label image type, an important consideration based on the total
 ...
 * supported.
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/structural_analysis_and_shape_descriptors.html#connectedcomponents">org.opencv.imgproc.Imgproc.connectedComponents</a>
 */
 ...
 *
 * <p>The function runs the Harris corner detector on the image. Similarly to
...
/**
 * <p>Creates a smart pointer to a LineSegmentDetector object and initializes it.</p>
 *
 * <p>The LineSegmentDetector algorithm is defined using the standard values. Only
 * advanced users may want to edit those, as to tailor it for their own
 * application.</p>
 *
 * @param _refine The way found lines will be refined:
 * <ul>
 *   <li> LSD_REFINE_NONE - No refinement applied.
 *   <li> LSD_REFINE_STD - Standard refinement is applied. E.g. breaking arches
 * into smaller straighter line approximations.
 *   <li> LSD_REFINE_ADV - Advanced refinement. Number of false alarms is
 * calculated, lines are refined through increase of precision, decrement in
 * size, etc.
 * </ul>
 * @param _scale a _scale
 * @param _sigma_scale a _sigma_scale
 * @param _quant a _quant
 * @param _ang_th a _ang_th
 * @param _log_eps a _log_eps
 * @param _density_th a _density_th
 * @param _n_bins a _n_bins
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/feature_detection.html#createlinesegmentdetector">org.opencv.imgproc.Imgproc.createLineSegmentDetector</a>
 */
 ...
 * <p>img *= 1./255;</p>
 *
 * <p>cvtColor(img, img, COLOR_BGR2Luv);</p>
 *
 ...
 * <ul>
 *   <li> RGB <em><-></em> GRAY (<code>COLOR_BGR2GRAY, COLOR_RGB2GRAY,
 * COLOR_GRAY2BGR, COLOR_GRAY2RGB</code>) Transformations within RGB space like
 * adding/removing the alpha channel, reversing the channel order, conversion
 * to/from 16-bit RGB color (R5:G6:B5 or R5:G5:B5), as well as conversion
 ...
 * <p>// C++ code:</p>
 *
 * <p>cvtColor(src, bwsrc, COLOR_RGB2GRAY);</p>
 *
 * <p></code></p>
 *
 ...
 * (<code>COLOR_BGR2XYZ, COLOR_RGB2XYZ, COLOR_XYZ2BGR, COLOR_XYZ2RGB</code>):
 * </ul>
 *
 * <p><em>X
 ...
 * <ul>
 *   <li> RGB <em><-></em> YCrCb JPEG (or YCC) (<code>COLOR_BGR2YCrCb,
 * COLOR_RGB2YCrCb, COLOR_YCrCb2BGR, COLOR_YCrCb2RGB</code>)
 * </ul>
 *
 ...
 * <ul>
 *   <li> RGB <em><-></em> HSV (<code>COLOR_BGR2HSV, COLOR_RGB2HSV,
 * COLOR_HSV2BGR, COLOR_HSV2RGB</code>) In case of 8-bit and 16-bit images, R,
 * G, and B are converted to the floating-point format and scaled to fit the 0
 * to 1 range.
 * </ul>
 *
 ...
 *   <li> RGB <em><-></em> HLS (<code>COLOR_BGR2HLS, COLOR_RGB2HLS,
 * COLOR_HLS2BGR, COLOR_HLS2RGB</code>).
 * </ul>
 ...
 *   <li> RGB <em><-></em> CIE L*a*b* (<code>COLOR_BGR2Lab, COLOR_RGB2Lab,
 * COLOR_Lab2BGR, COLOR_Lab2RGB</code>).
 * </ul>
 * <p>In case of 8-bit and 16-bit images, R, G, and B are converted to the
 * floating-point format and scaled to fit the 0 to 1 range.</p>
 *
 ...
 *   <li> RGB <em><-></em> CIE L*u*v* (<code>COLOR_BGR2Luv, COLOR_RGB2Luv,
 * COLOR_Luv2BGR, COLOR_Luv2RGB</code>).
 * </ul>
 * <p>In case of 8-bit and 16-bit images, R, G, and B are converted to the
 ...
 * <ul>
 *   <li> Bayer <em>-></em> RGB (<code>COLOR_BayerBG2BGR, COLOR_BayerGB2BGR,
 * COLOR_BayerRG2BGR, COLOR_BayerGR2BGR, COLOR_BayerBG2RGB, COLOR_BayerGB2RGB,
 * COLOR_BayerRG2RGB, COLOR_BayerGR2RGB</code>). The Bayer pattern is widely
 * used in CCD and CMOS cameras. It enables you to get color pictures from a
 * single plane where R,G, and B pixels (sensors of a particular component) are
 ...
 * @param dst output image of the same size and type as <code>src</code>.
 * @param kernel structuring element used for dilation; if <code>elemenat=Mat()</code>,
 * a <code>3 x 3</code> rectangular structuring element is used. Kernel can be
 * created using "getStructuringElement"
 ...
 * @param dstType Type of output image. It can be <code>CV_8U</code> or
 * <code>CV_32F</code>. Type <code>CV_8U</code> can be used only for the first
 * variant of the function and <code>distanceType == CV_DIST_L1</code>.
 *
 ...
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/drawing_functions.html#drawcontours">org.opencv.imgproc.Imgproc.drawContours</a>
 */
 ...
 * values of axes.
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/drawing_functions.html#ellipse">org.opencv.imgproc.Imgproc.ellipse</a>
 */
 ...
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/drawing_functions.html#ellipse2poly">org.opencv.imgproc.Imgproc.ellipse2Poly</a>
 */
 ...
 * <code>CV_16S</code>, <code>CV_32F" or </code>CV_64F".
 * @param dst output image of the same size and type as <code>src</code>.
 * @param kernel structuring element used for erosion; if <code>element=Mat()</code>,
 * a <code>3 x 3</code> rectangular structuring element is used. Kernel can be
 * created using "getStructuringElement".
 * @param anchor position of the anchor within the element; default value
 * <code>(-1, -1)</code> means that the anchor is at the element center.
 ...
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/drawing_functions.html#fillconvexpoly">org.opencv.imgproc.Imgproc.fillConvexPoly</a>
 */
 ...
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/drawing_functions.html#fillpoly">org.opencv.imgproc.Imgproc.fillPoly</a>
 */
 ...
 * kernels (~<code>11 x 11</code> or larger) and the direct algorithm for small
 * kernels.</p>
 *
 * @param src input image.
 * @param dst output image of the same size and the same number of channels as
 ...
 * (see "Sobel"). The filters are normally passed to "sepFilter2D" or to</p>
 *
 ...
 *
 * <p>For more details about gabor filter equations and parameters, see: Gabor
 * Filter (http://en.wikipedia.org/wiki/Gabor_filter).</p>
 *
 ...
 * <code>CV_64F</code>.
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/filtering.html#getgaborkernel">org.opencv.imgproc.Imgproc.getGaborKernel</a>
 */
 ...
 *
 * <p>Two of such generated kernels can be passed to "sepFilter2D". Those functions
 ...
 * further passed to "erode", "dilate" or "morphologyEx". But you can also
 ...
 * @param shift Number of fractional bits in the point coordinates.
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/drawing_functions.html#line">org.opencv.imgproc.Imgproc.line</a>
 */
...
/**
 * <p>Finds a triangle of minimum area enclosing a 2D point set and returns its
 * area.</p>
 *
 * <p>The function finds a triangle of minimum area enclosing the given set of 2D
 * points and returns its area. The output for a given 2D point set is shown in
 * the image below. 2D points are depicted in *red* and the enclosing triangle
 * in *yellow*.
 * :height: 250px <code></p>
 *
 * <p>// C++ code:</p>
 ...
 * <p>:width: 250px</p>
 *
 * <p>:alt: Sample output of the minimum enclosing triangle function</p>
 *
 * <p>The implementation of the algorithm is based on O'Rourke's [ORourke86] and
 * Klee and Laskowski's [KleeLaskowski85] papers. O'Rourke provides a </code></p>
 *
 * <p><em>theta(n)</em> algorithm for finding the minimal enclosing triangle of a
 * 2D convex polygon with <code>n</code> vertices. Since the "minEnclosingTriangle"
 * function takes a 2D point set as input an additional preprocessing step of
 * computing the convex hull of the 2D point set is required. The complexity of
 * the "convexHull" function is <em>O(n log(n))</em> which is higher than
 * <em>theta(n)</em>.
 * Thus the overall complexity of the function is <em>O(n log(n))</em>.</p>
 *
 * <p>Note: See <code>opencv_source/samples/cpp/minarea.cpp</code> for a usage
 * example.</p>
 *
 * @param points Input vector of 2D points with depth <code>CV_32S</code> or
 * <code>CV_32F</code>, stored in:
 * <ul>
 *   <li> <code>std.vector<></code> or <code>Mat</code> (C++ interface)
 *   <li> Nx2 numpy array (Python interface)
 * </ul>
 * @param triangle Output vector of three 2D points defining the vertices of the
 * triangle. The depth of the OutputArray must be <code>CV_32F</code>.
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/structural_analysis_and_shape_descriptors.html#minenclosingtriangle">org.opencv.imgproc.Imgproc.minEnclosingTriangle</a>
 */
 ...
 * effects (optional).
 * @param response Signal power within the 5x5 centroid around the peak, between
 * 0 and 1 (optional).
 *
 ...
 * @param shift Number of fractional bits in the vertex coordinates.
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/drawing_functions.html#polylines">org.opencv.imgproc.Imgproc.polylines</a>
 */
 ...
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/drawing_functions.html#puttext">org.opencv.imgproc.Imgproc.putText</a>
 */
 ...
 * supported). See <code>borderInterpolate</code> for details.
 *
 ...
 * See <code>borderInterpolate</code> for details.
 *
 ...
 * @param shift Number of fractional bits in the point coordinates.
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/drawing_functions.html#rectangle">org.opencv.imgproc.Imgproc.rectangle</a>
 */
...
/**
 * <p>Finds out if there is any intersection between two rotated rectangles. If
 * there is then the vertices of the interesecting region are returned as well.</p>
 *
 * <p>The following values are returned by the function:</p>
 * <ul>
 *   <li> INTERSECT_NONE=0 - No intersection
 *   <li> INTERSECT_PARTIAL=1 - There is a partial intersection
 *   <li> INTERSECT_FULL=2 - One of the rectangle is fully enclosed in the other
 * </ul>
 *
 * <p>Below are some examples of intersection configurations. The hatched pattern
 * indicates the intersecting region and the red vertices are returned by the
 * function.</p>
 *
 * @param rect1 First rectangle
 * @param rect2 Second rectangle
 * @param intersectingRegion The output array of the verticies of the
 * intersecting region. It returns at most 8 vertices. Stored as
 * <code>std.vector<cv.Point2f></code> or <code>cv.Mat</code> as Mx1 of type
 * CV_32FC2.
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/structural_analysis_and_shape_descriptors.html#rotatedrectangleintersection">org.opencv.imgproc.Imgproc.rotatedRectangleIntersection</a>
 */
 ...
 *
 * @see <a href="http://docs.opencv.org/modules/imgproc/doc/drawing_functions.html#gettextsize">org.opencv.imgproc.Imgproc.getTextSize</a>
 */
