 ...
 *
 * <p>virtual void add(InputArrayOfArrays descriptors);</p>
 *
 ...
 * </ul>
 *
 * <p>void match(InputArray queryDescriptors, InputArray trainDescriptors,</p>
 *
 * <p>vector<DMatch>& matches, InputArray mask=noArray()) const;</p>
 *
 * <p>void knnMatch(InputArray queryDescriptors, InputArray trainDescriptors,</p>
 *
 * <p>vector<vector<DMatch> >& matches, int k,</p>
 *
 * <p>InputArray mask=noArray(), bool compactResult=false) const;</p>
 *
 * <p>void radiusMatch(InputArray queryDescriptors, InputArray trainDescriptors,</p>
 *
 ...
 * </ul>
 *
 * <p>void match(InputArray queryDescriptors, vector<DMatch>& matches,</p>
 *
 * <p>InputArrayOfArrays masks=noArray());</p>
 *
 * <p>void knnMatch(InputArray queryDescriptors, vector<vector<DMatch> >& matches,</p>
 *
 * <p>int k, InputArrayOfArrays masks=noArray(),</p>
 *
 * <p>bool compactResult=false);</p>
 *
 * <p>void radiusMatch(InputArray queryDescriptors, vector<vector<DMatch> >&
 * matches,</p>
 *
 * <p>float maxDistance, InputArrayOfArrays masks=noArray(),</p>
 *
 * <p>bool compactResult=false);</p>
 *
 ...
 *
 * <p>vector<UMat> utrainDescCollection;...</p>
 *
 * <p>};</p>
 *
...
/**
 * <p>Adds descriptors to train a CPU(<code>trainDescCollectionis</code>) or
 * GPU(<code>utrainDescCollectionis</code>) descriptor collection. If the
 * collection is not empty, the new descriptors are added to existing train
 * descriptors.</p>
 *
 ...
 */
    ...
    //
    // C++:  void javaDescriptorMatcher::knnMatch(Mat queryDescriptors, vector_vector_DMatch& matches, int k, vector_Mat masks = std::vector<Mat>(), bool compactResult = false)
    //
 ...
 */
    ...
    //
    // C++:  void javaDescriptorMatcher::match(Mat queryDescriptors, vector_DMatch& matches, vector_Mat masks = std::vector<Mat>())
    //
 ...
 */
    ...
    //
    // C++:  void javaDescriptorMatcher::radiusMatch(Mat queryDescriptors, vector_vector_DMatch& matches, float maxDistance, vector_Mat masks = std::vector<Mat>(), bool compactResult = false)
    //
