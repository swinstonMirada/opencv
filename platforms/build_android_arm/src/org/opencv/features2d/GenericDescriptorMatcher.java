 ...
 *
 * <p>virtual void add(InputArrayOfArrays images,</p>
 *
 ...
 *
 * <p>void classify(InputArray queryImage,</p>
 *
 * <p>vector<KeyPoint>& queryKeypoints,</p>
 *
 * <p>InputArray trainImage,</p>
 *
 ...
 * </ul>
 *
 * <p>void match(InputArray queryImage, vector<KeyPoint>& queryKeypoints,</p>
 *
 * <p>InputArray trainImage, vector<KeyPoint>& trainKeypoints,</p>
 *
 * <p>vector<DMatch>& matches, InputArray mask=noArray()) const;</p>
 *
 * <p>void knnMatch(InputArray queryImage, vector<KeyPoint>& queryKeypoints,</p>
 *
 * <p>InputArray trainImage, vector<KeyPoint>& trainKeypoints,</p>
 *
 ...
 *
 * <p>void radiusMatch(InputArray queryImage, vector<KeyPoint>& queryKeypoints,</p>
 *
 * <p>InputArray trainImage, vector<KeyPoint>& trainKeypoints,</p>
 *
 ...
 * <p>void match(InputArray queryImage, vector<KeyPoint>& queryKeypoints,</p>
 *
 * <p>vector<DMatch>& matches, InputArrayOfArrays masks=noArray());</p>
 *
 * <p>void knnMatch(InputArray queryImage, vector<KeyPoint>& queryKeypoints,</p>
 *
 * <p>vector<vector<DMatch> >& matches, int k,</p>
 *
 * <p>InputArrayOfArrays masks=noArray(), bool compactResult=false);</p>
 *
 * <p>void radiusMatch(InputArray queryImage, vector<KeyPoint>& queryKeypoints,</p>
 *
 * <p>vector<vector<DMatch> >& matches, float maxDistance,</p>
 ...
 */
    ...
    //
    // C++:  void javaGenericDescriptorMatcher::knnMatch(Mat queryImage, vector_KeyPoint queryKeypoints, vector_vector_DMatch& matches, int k, vector_Mat masks = std::vector<Mat>(), bool compactResult = false)
    //
 ...
 */
    ...
    //
    // C++:  void javaGenericDescriptorMatcher::match(Mat queryImage, vector_KeyPoint queryKeypoints, vector_DMatch& matches, vector_Mat masks = std::vector<Mat>())
    //
 ...
 */
    ...
    //
    // C++:  void javaGenericDescriptorMatcher::radiusMatch(Mat queryImage, vector_KeyPoint queryKeypoints, vector_vector_DMatch& matches, float maxDistance, vector_Mat masks = std::vector<Mat>(), bool compactResult = false)
    //
