...
if(TRUE) # value is defined by package builder
  if(NOT TARGET ippicv)
    if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/../../3rdparty/ippicv/unpack/ippicv_lnx/lib/ia32/libippicv.a")
      add_library(ippicv STATIC IMPORTED)
      set_target_properties(ippicv PROPERTIES
        IMPORTED_LINK_INTERFACE_LIBRARIES ""
        IMPORTED_LOCATION "${CMAKE_CURRENT_LIST_DIR}/../../3rdparty/ippicv/unpack/ippicv_lnx/lib/ia32/libippicv.a"
      )
    endif()
  endif()
endif()
...
set(OpenCV_INCLUDE_DIRS "/Users/swinston/Mirada/lib/c/opencv/platforms/build_android_x86" "/Users/swinston/Mirada/lib/c/opencv/include" "/Users/swinston/Mirada/lib/c/opencv/include/opencv")
