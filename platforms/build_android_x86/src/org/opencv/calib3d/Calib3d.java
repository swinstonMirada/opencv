 ...
 * p_1, p_2[, k_3[, k_4, k_5, k_6],[s_1, s_2, s_3, s_4]])</em> of 4, 5, 8 or 12
 * elements.
 ...
 *   <li> CALIB_THIN_PRISM_MODEL Coefficients s1, s2, s3 and s4 are enabled. To
 * provide the backward compatibility, this extra flag should be explicitly
 ...
 *   <li> CALIB_FIX_S1_S2_S3_S4 The thin prism distortion coefficients are not
 * changed during the optimization. If <code>CV_CALIB_USE_INTRINSIC_GUESS</code>
...
/**
 * <p>Decompose an essential matrix to possible rotations and translation.</p>
 *
 * <p>This function decompose an essential matrix <code>E</code> using svd
 * decomposition [HartleyZ00]. Generally 4 possible poses exists for a given
 * <code>E</code>.
 * They are <em>[R_1, t]</em>, <em>[R_1, -t]</em>, <em>[R_2, t]</em>, <em>[R_2,
 * -t]</em>.
 * By decomposing <code>E</code>, you can only get the direction of the
 * translation, so the function returns unit <code>t</code>.</p>
 *
 ...
 *
 * @see <a href="http://docs.opencv.org/modules/calib3d/doc/camera_calibration_and_3d_reconstruction.html#decomposeessentialmat">org.opencv.calib3d.Calib3d.decomposeEssentialMat</a>
 */
 ...
 */
    ...
    //
    // C++:  bool findCirclesGrid(Mat image, Size patternSize, Mat& centers, int flags = CALIB_CB_SYMMETRIC_GRID, Ptr_FeatureDetector blobDetector = makePtr<SimpleBlobDetector>())
    //

/**
 * <p>Finds centers in the grid of circles.</p>
 *
 * <p>The function attempts to determine whether the input image contains a grid of
 ...
 * returns 0.
 * Sample usage of detecting and drawing the centers of circles: <code></p>
 *
 * <p>// C++ code:</p>
 *
 * <p>Size patternsize(7,7); //number of centers</p>
 *
 * <p>Mat gray =....; //source image</p>
 *
 * <p>vector<Point2f> centers; //this will be filled by the detected centers</p>
 *
 * <p>bool patternfound = findCirclesGrid(gray, patternsize, centers);</p>
 *
 * <p>drawChessboardCorners(img, patternsize, Mat(centers), patternfound);</p>
 *
 * <p>Note: The function requires white space (like a square-thick border, the
 * wider the better) around the board to make the detection more robust in
 ...
 * color image.
 * @param patternSize number of circles per row and column <code>(patternSize =
 * Size(points_per_row, points_per_colum))</code>.
 * @param centers output array of detected centers.
 * @param flags various operation flags that can be one of the following values:
 * <ul>
 *   <li> CALIB_CB_SYMMETRIC_GRID uses symmetric pattern of circles.
 *   <li> CALIB_CB_ASYMMETRIC_GRID uses asymmetric pattern of circles.
 *   <li> CALIB_CB_CLUSTERING uses a special algorithm for grid detection. It is
 * more robust to perspective distortions but much more sensitive to background
 * clutter.
 * </ul>
 *
 * @see <a href="http://docs.opencv.org/modules/calib3d/doc/camera_calibration_and_3d_reconstruction.html#findcirclesgrid">org.opencv.calib3d.Calib3d.findCirclesGrid</a>
 */
...
/**
 * <p>Calculates an essential matrix from the corresponding points in two images.</p>
 *
 * <p>This function estimates essential matrix based on the five-point algorithm
 * solver in [Nister03]. [SteweniusCFS] is also a related.
 * The epipolar geometry is described by the following equation:</p>
 *
 * <p><em>[p_2; 1]^T K^T E K [p_1; 1] = 0
 * </em></p>
 *
 * <p>K =
 * begin{bmatrix} f & 0 & x_{pp} \
 * 0 & f & y_{pp} \
 * 0 & 0 & 1 end{bmatrix}</p>
 *
 ...
 * <code>points1</code> and <code>points2</code> are feature points from cameras
 * with same focal length and principle point.
 * @param pp principle point of the camera.
 * @param method Method for computing a fundamental matrix.
 * <ul>
 *   <li> RANSAC for the RANSAC algorithm.
 *   <li> MEDS for the LMedS algorithm.
 * </ul>
 * @param prob Parameter used for the RANSAC or LMedS methods only. It specifies
 * a desirable level of confidence (probability) that the estimated matrix is
 * correct.
 ...
 * RANSAC and LMedS methods.
 *
 * @see <a href="http://docs.opencv.org/modules/calib3d/doc/camera_calibration_and_3d_reconstruction.html#findessentialmat">org.opencv.calib3d.Calib3d.findEssentialMat</a>
 */
 ...
 *   <li> RANSAC - RANSAC-based robust method
 *   <li> LMEDS - Least-Median robust method
 * </ul>
 ...
 * p_2[, k_3[, k_4, k_5, k_6],[s_1, s_2, s_3, s_4]])</em> of 4, 5, 8 or 12
 * elements. If the vector is NULL/empty, the zero distortion coefficients are
 * assumed.
...
/**
 * <p>Recover relative camera rotation and translation from an estimated essential
 ...
 *
 *
 * <p>double focal = 1.0;</p>
 *
 * <p>cv.Point2d pp(0.0, 0.0);</p>
 *
 * <p>Mat E, R, t, mask;</p>
 *
 * <p>E = findEssentialMat(points1, points2, focal, pp, RANSAC, 0.999, 1.0, mask);</p>
 *
 * <p>recoverPose(E, points1, points2, R, t, focal, pp, mask);</p>
 *
 * @param E The input essential matrix.
 * @param points1 Array of <code>N</code> 2D points from the first image. The
 ...
 * with same focal length and principle point.
 * @param pp Principle point of the camera.
 * @param mask Input/output mask for inliers in <code>points1</code> and
 * <code>points2</code>.
 * <p>If it is not empty, then it marks inliers in <code>points1</code> and
 * <code>points2</code> for then given essential matrix <code>E</code>.
 * Only these inliers will be used to recover pose.
 * In the output mask only inliers which pass the cheirality check.</p>
 *
 * @see <a href="http://docs.opencv.org/modules/calib3d/doc/camera_calibration_and_3d_reconstruction.html#recoverpose">org.opencv.calib3d.Calib3d.recoverPose</a>
 */
 ...
 * that corresponds to the outliers (see :ocv:funcx:"StereoMatcher.compute")
 * are transformed to 3D points with a very large Z value (currently set to
 * 10000).
 ...
 * k_2, p_1, p_2[, k_3[, k_4, k_5, k_6],[s_1, s_2, s_3, s_4]])</em> of 4, 5, 8
 * ot 12 elements. The output vector length depends on the flags.
